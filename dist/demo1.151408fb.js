...
},{"gsap":"../node_modules/gsap/index.js","./utils":"js/utils.js"}],"../node_modules/splitting/dist/splitting.css":[function(require,module,exports) {
    ...
    value: function navigate(direction) {
      ...
      if (nextSlide.DOM.el.querySelector("[data-word='Blue']")) {
        ...
        for (var _i4 = 0; _i4 < allPath.length; _i4++) {
          allPath[_i4].setAttribute("fill", "#f8a815");

          allPath[_i4].setAttribute("stroke", "#f8a815");
        }
        ...
        document.body.classList.add("background-bluesquare"); // gsap.to(this.DOM);
      }
      ...
      if (nextSlide.DOM.el.querySelector("[data-word='Ania']")) {
        for (var _i8 = 0; _i8 < allPath.length; _i8++) {
          allPath[_i8].setAttribute("fill", "#01968d");

          allPath[_i8].setAttribute("stroke", "#01968d");
        }
      ...
      if (nextSlide.DOM.el.querySelector("[data-word='Devo']")) {
        for (var _i10 = 0; _i10 < allPath.length; _i10++) {
          allPath[_i10].setAttribute("fill", "#ff8089");

          allPath[_i10].setAttribute("stroke", "#ff8089");
        }
      ...
      if (nextSlide.DOM.el.querySelector("[data-word='Crypto']")) {
        for (var _i12 = 0; _i12 < allPath.length; _i12++) {
          allPath[_i12].setAttribute("fill", "#6581e1");

          allPath[_i12].setAttribute("stroke", "#6581e1");
        }
...
},{"splitting/dist/splitting.css":"../node_modules/splitting/dist/splitting.css","splitting/dist/splitting-cells.css":"../node_modules/splitting/dist/splitting.css","gsap":"../node_modules/gsap/index.js","../slide":"js/slide.js","../../imgYag/AV/background-av.png":"imgYag/AV/background-av.png","../../imgYag/DigitalIn/Background.png":"imgYag/DigitalIn/Background.png"}],"js/demo1/navigateBluesquare.js":[function(require,module,exports) {
"use strict";
...
var SeeProject = exports.default =
/*#__PURE__*/
function () {
  function SeeProject(el) {
    _classCallCheck(this, SeeProject);
    ...
    this.back = document.body.querySelector(".go-back"); // setTimeout(() => {

    this.initEvents(); // }, 1000);
  }

  _createClass(SeeProject, [{
    key: "initEvents",
    value: function initEvents() {
      var _this = this;

      // console.log(this.DOM.el.querySelector(".see__more"), document.body.querySelector(".go-back"));
      this.onClickBtnSeeMore = function () {
...
},{"gsap":"../node_modules/gsap/index.js"}],"js/demo1/index.js":[function(require,module,exports) {
"use strict";
...
var _navigateBluesquare = _interopRequireDefault(require("./navigateBluesquare"));
...
Promise.all([(0, _utils.preloadImages)(".slide__img"), (0, _utils.preloadFonts)("ldj8uhs")]).then(function () {
  ...
  var cursor = new _cursor.default(document.querySelector(".cursor")); // Initialize the slideshow & the SeeProject

  new _slideshow.default(document.querySelector(".slides"));
  new _navigateBluesquare.default(document.querySelector(".slides")); // mouse cursor hovers
...
document.addEventListener("DOMContentLoaded", function () {
  new _slideshow.default(document.querySelector(".slides"));
  new _navigateBluesquare.default(document.querySelector(".slides"));
});
},{"../utils":"js/utils.js","../cursor":"js/cursor.js","./slideshow":"js/demo1/slideshow.js","./navigateBluesquare":"js/demo1/navigateBluesquare.js"}]},{},["js/demo1/index.js"], null)
